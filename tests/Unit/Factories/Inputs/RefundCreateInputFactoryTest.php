...
class RefundCreateInputFactoryTest extends TestCase
{
     ...
     */
    public function test_returned_input_interface_is_refund_create_input(): void
    {
     ...
     */
    public function test_created_input_reason_property_is_empty_string_if_provided_reason_argument_is_null(): void
    {
        $factory = new RefundCreateInputFactory();
